...
def UNIdjSL(tokens, source_coin, starting_USD):
    ...
    while(u != 'Elena Protocol'):
        ...
        for tok in tokens.items():
            ...
            #1) false in spt_set (has not been found)
            #2) there is an edge from u to v
            #3) total weight of path from source_coin to tok through u is smaller than current value of dist[tok]
